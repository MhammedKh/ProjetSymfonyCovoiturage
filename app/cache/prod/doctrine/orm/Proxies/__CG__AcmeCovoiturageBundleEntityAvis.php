 ...
 */
class Avis extends \Acme\CovoiturageBundle\Entity\Avis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Avis' . "\0" . 'note', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Avis' . "\0" . 'id', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Avis' . "\0" . 'idUtilisateur', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Avis' . "\0" . 'idAnnonce');
        }
