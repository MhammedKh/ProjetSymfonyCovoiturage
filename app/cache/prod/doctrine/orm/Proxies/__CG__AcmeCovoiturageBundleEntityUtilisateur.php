 ...
 */
class Utilisateur extends \Acme\CovoiturageBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'tel', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'photo', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'login', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'password', '' . "\0" . 'Acme\\CovoiturageBundle\\Entity\\Utilisateur' . "\0" . 'id');
        }
