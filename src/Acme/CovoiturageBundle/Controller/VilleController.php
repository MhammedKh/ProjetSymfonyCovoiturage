...
use Acme\CovoiturageBundle\Entity\Ville;
use Acme\CovoiturageBundle\Form\VilleType;
...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeCovoiturageBundle:Ville')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeCovoiturageBundle:Ville:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeCovoiturageBundle:Ville')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeCovoiturageBundle:Ville:edit.html.twig")
     */
